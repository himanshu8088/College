...
public abstract class StickerView extends FrameLayout{
    ...
    public double changeWidth=0,changeHeight=0;
    ...
    private final static int SELF_SIZE_DP = 50;
    ...
    private void init(final Context context){
        ...
        this.iv_save = new ImageView(context);
        this.iv_scale.setImageResource(R.drawable.zoominout);
        this.iv_save.setImageResource(R.drawable.sst);
        this.setTag("DraggableViewGroup");
        this.iv_border.setTag("iv_border");
        this.iv_scale.setTag("iv_scale");
        this.iv_save.setTag("iv_delete");
        int margin = convertDpToPixel(BUTTON_SIZE_DP+20, getContext())/2;
        int size = convertDpToPixel(SELF_SIZE_DP+20, getContext());
        ...
        LayoutParams iv_save_params =
                new LayoutParams(
                        convertDpToPixel(BUTTON_SIZE_DP, getContext()),
                        convertDpToPixel(BUTTON_SIZE_DP, getContext())
                );
        iv_save_params.gravity = Gravity.TOP | Gravity.RIGHT;
        ...
        this.addView(iv_save, iv_save_params);
        this.setOnTouchListener(mTouchListener);
        this.iv_scale.setOnTouchListener(mTouchListener);
        this.iv_save.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if(StickerView.this.getParent()!=null){
                    Location l=new Location(StickerView.this.getX(),StickerView.this.getY());
                    com.projectwatermark.Size s=new com.projectwatermark.Size(iv_border.getWidth(),iv_border.getHeight());
                    Intent i=new Intent(context,ProgressBarWithNotification.class);
                    context.startActivity(i);
                }
            }
        });
        changeHeight=StickerView.this.getLayoutParams().height;
        changeWidth=StickerView.this.getLayoutParams().width;
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        if(length2 > length1
                            ...
                            changeHeight=StickerView.this.getHeight();
                            changeWidth=StickerView.this.getWidth();
